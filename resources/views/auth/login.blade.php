                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center m-md-3" >
                                    <img src="{{asset('logo.jpeg')}}" class="img-thumbnail" alt="">
                                </div>
                                <form action="{{asset('login')}}" method="post" class="user">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        @error('email')
                                            <span class="alert_danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
